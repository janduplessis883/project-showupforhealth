...
def sort_df_columns(df):
    new_df = df[['temp', 'precipitation', 'Age', 'Sex', 'FRAILTY', 'DEPRESSION',
       'OBESITY', 'IHD', 'DM', 'HPT', 'NDHG', 'SMI', 'IMD2023',
       ...
       'cos_month', 'sin_day_of_week', 'cos_day_of_week', 'No_shows',
       'Rota_ARRS', 'Rota_GP', 'Rota_HCA', 'Rota_Nurse', 'Ethnicity_Asian',
